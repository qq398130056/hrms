            ...
            if (flag) {
                ...
                $.post("${pageContext.request.contextPath}/user/login", {
                    ...
                    if (user == null) {
                        ...
                        window.location.href = "/main.jsp?id=" + user.id;
                    }
                })
                return true;
            }
...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form id="login-form" class="container offset1 loginform" action="javascript:void(0)" method="post">
                <!-- 猫头鹰控件 -->
                <div class="login-owl">
                    <div class="hand"></div>
                    ...
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="login-username"
                                       autocomplete="off" placeholder="请输入用户名" name="account" tabindex="1"
                                       maxlength="15"/>
        ...
        <div class="login sign-out-htm">
            <form action="javascript:void(0)" method="post" class="container offset1 loginform">
                <!-- 猫头鹰控件 -->
                <div class="forget-owl">
                    <div class="hand"></div>
                    <div class="hand hand-r"></div>
                    <div class="arms">
                        <div class="arm"></div>
